...
const en: Record<string, string> = {
  ...
  'settings.exportFormat.desc': 'MP4 plays everywhere. MOV is for editors like Final Cut. Sharing always uses MP4.',
...
const es: Record<string, string> = {
  ...
  'settings.exportFormat.desc': 'MP4 funciona en todas partes. MOV, para editores como Final Cut. Al compartir siempre se usa MP4.',
